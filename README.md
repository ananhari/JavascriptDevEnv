...
2. **Clone this repository.** - `git clone https://github.com/ananhari/JavaScriptDevEnv.git` or [download the zip](https://github.com/ananhari/JavaScriptDevEnv/archive/master.zip)
